...
## [1]{style="color:skyblue"} Overview
...
## [2]{style="color:skyblue"} Install and Launch R Packages
...
## [3]{style="color:skyblue"} Import Data
...
## [4]{style="color:skyblue"} FunnelPlotR Methods
...
### [4.1]{style="color:skyblue"} FunnelPlotR methods: Basic plot
...
### [4.2]{style="color:skyblue"} FunnelPlotR methods: Makeover 1
...
### [4.3]{style="color:skyblue"} FunnelPlotR methods: Makeover 2
...
## [5]{style="color:skyblue"} Funnel Plot for Fair Visual Comparison: `ggplot2` methods
...
### [5.1]{style="color:skyblue"} Computing the basic derived fields
...
### [5.2]{style="color:skyblue"} Calculate lower and upper limits for 95% and 99.9% CI
...
### [5.3]{style="color:skyblue"} Plot a static funnel plot
...
### [5.4]{style="color:skyblue"} Interactive funnel plot: `plotly` + `ggplot2`
...
## [6]{style="color:skyblue"} References
