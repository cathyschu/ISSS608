...
tm_shape(mpsz_pop2020)+
  ...
  tm_borders(alpha = 0.5) +
  tm_compass(type="8star", size = 2) +
  tm_scale_bar() +  # Use default parameters instead of specifying width
...
tm_shape(mpsz_pop2020)+
  ...
  tm_layout(legend.position = c("right", "bottom"),
            legend.width = 5,         # Controls the width of legend
            legend.height = 6,        # Controls the height of legend
            legend.text.size = 0.7,      # Makes the text in the legend smaller
