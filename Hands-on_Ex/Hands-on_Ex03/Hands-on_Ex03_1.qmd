...
🦄 **`highlight_key()`**: This function simply creates an object of class [**crosstalk::SharedData**](https://www.rdocumentation.org/link/crosstalk%3A%3ASharedData?package=plotly&version=4.9.2&to=crosstalk%3ASharedData). The reason it exists is to make it easier to teach others how to leverage its functionality in plotly. It also makes it more discoverable if one is already aware of [**highlight**](https://www.rdocumentation.org/link/highlight?package=plotly&version=4.9.2).

🎯 Read more on [`subplot()`](https://plotly.com/r/subplots/)
...
### [3.8.1]{style="color:skyblue"} Interactive Data Table: DT package
...
### [3.8.2]{style="color:skyblue"} Linked brushing: crosstalk method
...
### [3.9.1]{style="color:skyblue"} ggiraph
...
### [3.9.2]{style="color:skyblue"} plotly for R
