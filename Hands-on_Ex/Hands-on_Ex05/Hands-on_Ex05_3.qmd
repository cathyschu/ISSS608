...
The data of [World Happines 2018 report](https://worldhappiness.report/ed/2018/) called ***WHData-2018.csv*** will be used.
...
## 3 Transform data frame to matrix
...
**Resource:** [Introduction to Heatmaply](https://cran.r-project.org/web/packages/heatmaply/vignettes/heatmaply.html) & [user manual](https://cran.r-project.org/web/packages/heatmaply/heatmaply.pdf)
