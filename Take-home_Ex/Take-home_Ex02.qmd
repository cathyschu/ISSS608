...
p <- ggplot(slope_data_top, aes(x = Year, y = Value, 
  ...
  scale_color_manual(values = colorRampPalette(c("#A3D1C6", "#D95F02", "#C599B6", "#FF8989", "#A4B465", "#E6AB02", "#2DAA9E", "grey50", "#D69ADE", "#88CCEE"))(10)) +
  scale_y_continuous(
  ...
  theme(legend.position = "bottom",
        ...
        plot.subtitle = element_text(hjust = 0.5, size = 14, face = "bold", family = "Arial"),
