...
1.  **Time-Series Analysis:** Visualising Singapore’s monthly trade data from 1999 onwards to identify trends and patterns.

2.  **Time-Series Forecasting:** – Applying forecasting models to evaluate future trade dynamics and interpreting the results.

### 3.2 Data

The main dataset is the Merchandise Trade Excel files downloaded from [the Department of Statistics Singapore](https://www.singstat.gov.sg/find-data/search-by-theme/trade-and-investment/merchandise-trade/latest-data). The Excel file includes 3 sets of data: 
1. *Merchandise Trade By Region And Selected Market (Imports), Monthly*
2. *Merchandise Trade By Region And Selected Market (Domestic Exports), Monthly*
3. *Merchandise Trade By Region And Selected Market (Re-Exports), Monthly.* 
The data spans from January 2003 to January 2025. However, for most analyses in this report, only data from 2015 to 2025 is used. The dataset covers 160 countries and regions, with some entries representing aggregated data.
...
::: tdgoals-container
-   **Widening gap in strong trade markets -** Ahe time plot reveals four markets — **Taiwan, China, the US, Malaysia** - showing a consistent upward trend, creating a growing gap between them and other markets.
...
-   **Trend -** Countries like **China, South Korea, Taiwan, Malaysia, Thailand, the US**, and **UAE** show an increasing trend, supported by slow decay in their ACF plots. In contrast, **Saudi Arabia** demonstrates a decreasing trend. 
...
::: tdgoals-container
-   **Consistent gap in strong trade markets -** Unlike Import, the stronger Export trade markets, including China, Malaysia, the US, and Indonesia maintains a consistent gap between them and other markets. Note that the gap isn't notable for Indonesia and Malaysia between year 2020-2022.
-   **Cyclic behaviour -** **Hong Kong’s** trade data appears to exhibit cyclic behavior with peaks at regular intervals (3, 6, 8, and 11 months), which could suggest seasonality or external cyclical influences on trade. The seasonality isn't observed at particular month. Like Hong Kong, the regular peaks in the ACF plot at lag 3, 6, 9, and 12 suggest that there is a cyclical or periodic pattern in **South Korea’s** trade behavior. Dips in Feb, May and Nov, and peaks in Mar, October Dec are observed for Korea. **Taiwan** and **Malaysia** have a peak at lag 12 and 7 respectively. This could indicate that Taiwan’s trade behavior has a seasonal or annual pattern, possibly linked to industry cycles such as electronics manufacturing (especially for semiconductors, which Taiwan is known for). Malaysia's trade patterns could be influenced by semi-annual cycles or business rhythms that occur every 7 months.
-   **Trend -** Countries like **Australia, Indonesia, Korea**, and **the USA** show an increasing trend, supported by slow decay in their ACF plots. In contrast, **Hong Kong** demonstrates a decreasing trend. 
:::
:::::
...
The analyse the trade trends, a ggHoriPlot will be plotted to observed the trends among Singapore trade partners. This approach is employeed because I would like to see all countries in one view.
To plot the ggHoriPlot, I will load and launch the following packages: **ggHoriPlot**, **ggthemes** and **tidyverse**.
```{r}
