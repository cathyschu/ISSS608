...
-   **Recommendation for future analysis**: Future work should include statistical significance testing of the observed patterns and changes. More sophisticated machine learning techniques could be explored for more accurate trade flow predictions. Additionally, incorporating complementary datasets such as GDP, inflation rates, and currency exchange fluctuations would provide a more comprehensive view of Singapore's trade dynamics.
