...
ship_treemap <- ship_filter %>%
  ...
  summarise(
    ...
    Total_Distance = sum(Cargo_Weight_tons, na.rm = TRUE),
    Voyage_Count = n()
  ) %>%
  ungroup()  
...
-   Tankers maintained relatively stable profits compared to the other ship types.
